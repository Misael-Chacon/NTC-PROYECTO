...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-04-2019 a las 15:27:46
...
INSERT INTO `tbl_universidades_x_tbl_carreras` (`codigo_universidad`, `codigo_carrera`, `codigo_usuario`, `codigo_clase`) VALUES
(1, 1, NULL, NULL),
(1, 2, NULL, NULL),
(1, 3, NULL, NULL),
(1, 4, NULL, NULL),
...
--
ALTER TABLE `tbl_clases`
  MODIFY `codigo_clase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
